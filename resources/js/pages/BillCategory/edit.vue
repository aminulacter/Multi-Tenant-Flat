...
const submitForm = () => {
    ...
    try {
        ...
        router.put(`/bill-categories/${billCategory.id}`, formData, {
            onSuccess: () => {
...
const resetForm = () => {
    form.name = billCategory.name || '';
    form.description = billCategory.description || '';
    errors.value = {};
};
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex justify-between items-center mb-6">
                            <h1 class="text-2xl font-bold text-gray-900">Edit Bill Category</h1>
                            <Link 
                        ...
                        <form @submit.prevent="submitForm" class="space-y-6">
                            ...
                            <div class="flex items-center justify-end space-x-4">
                                ...
                                >
                                    {{ isSubmitting ? 'Updating...' : 'Update Bill Category' }}
                                </button>
                            </div>
                        </form>
                    </div>
